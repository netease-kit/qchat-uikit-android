...
public class QChatPhotoView extends View
  ...
  public QChatPhotoView(Context context) {
    super(context);
    initialize();
  }

  public QChatPhotoView(Context context, AttributeSet attrs) {
    super(context, attrs);
    initialize();
  }

  public QChatPhotoView(Context context, AttributeSet attrs, int defStyle) {
  ...
  private void initialize() {
    ...
    if (!sInitialized) {
      ...
      sCropSize = resources.getDimensionPixelSize(R.dimen.qchat_photo_crop_width);

      sCropDimPaint = new Paint();
      sCropDimPaint.setAntiAlias(true);
      sCropDimPaint.setColor(resources.getColor(R.color.qchat_photo_crop_dim_color));
      sCropDimPaint.setStyle(Style.FILL);

      sCropPaint = new Paint();
      sCropPaint.setAntiAlias(true);
      sCropPaint.setColor(resources.getColor(R.color.qchat_photo_crop_highlight_color));
      sCropPaint.setStyle(Style.STROKE);
      sCropPaint.setStrokeWidth(resources.getDimension(R.dimen.qchat_photo_crop_stroke_width));
  ...
  private static class ScaleRunnable implements Runnable {
    ...
    private final QChatPhotoView mHeader;
    ...
    public ScaleRunnable(QChatPhotoView header) {
      mHeader = header;
    }
  ...
  private static class TranslateRunnable implements Runnable {
    ...
    public TranslateRunnable(QChatPhotoView header) {
      mLastRunTime = NEVER;
      mHeader = header;
    }
  ...
  private static class SnapRunnable implements Runnable {
    ...
    public SnapRunnable(QChatPhotoView header) {
      mStartRunTime = NEVER;
      mHeader = header;
    }
  ...
  private static class RotateRunnable implements Runnable {
    ...
    public RotateRunnable(QChatPhotoView header) {
      mHeader = header;
    }
