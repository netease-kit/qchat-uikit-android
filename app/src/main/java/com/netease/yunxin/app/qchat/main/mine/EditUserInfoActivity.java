...
public class EditUserInfoActivity extends BaseActivity {
    ...
    binding.tvDone.setOnClickListener(
        v -> {
          ...
          ContactRepo.updateSelfUserProfile(
              buildUpdateParam(),
              new com.netease.yunxin.kit.corekit.im2.extend.FetchCallback<Void>() {
                @Override
  ...
  private void loadData() {
    String account = com.netease.yunxin.kit.corekit.im2.IMKitClient.account();
    ...
    ContactRepo.getUserInfo(
        ...
        new com.netease.yunxin.kit.corekit.im2.extend.FetchCallback<List<V2NIMUser>>() {
          @Override
